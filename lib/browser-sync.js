...
bs.create = function (userOptions, cb) {
    ...
    function go(options) {
        ...
        const updatableOptions = ['clientJs', 'rewriteRules', 'middleware'];
        ...
        bs.setOption = function (selector, fn) {
            ...
            return Rx.Observable.just({
                ...
                .do(x => console.log(x.get('files').toJS()))
                .do(x => optSub.onNext(x))
                .take(1);

            // todo: apply conditional logic if an option changed that requires it.
