...
bs.create = function (userOptions, cb) {
    ...
    function go (options) {
        ...
        corestream
            ...
            .do(x => bsSocket.send(protocol.send('Global.reload', true)))
            .subscribe();
        ...
        corestream
            ...
            .do(x => console.log(x))
            .do(x => bsSocket.send(protocol.send('Global.inject', x)))
            .subscribe();
        ...
        var bs = {
            ...
            setOption: function (selector, fn) {
                ...
                .do(x => bsSocket.clients.emit('options:set', {options: transform.getClientOptions(x)}))
                .publish().refCount();
            },
            /**
