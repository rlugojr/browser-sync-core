...
bs.create = function (userOptions, cb) {
    ...
    function go (options) {
        ...
        var _bs = {};
        Object.defineProperty(_bs, 'options', {
            get: function () {
                return options;
            }
        });
        var bsServer     = server.create(options);
        var bsSocket     = sockets.create(bsServer.server, _bs);
        var bsClients    = bsSocket.io.of(options.getIn(["socket", "namespace"]));
        ...
        corestream
            ...
            .do(x => bsClients.emit('browser:reload'))
            .subscribe();
        ...
        corestream
            ...
            .do(x => bsClients.emit('file:reload', x))
            .subscribe();
        ...
        var bs = {
            ...
            setOption: function (selector, fn) {
                ...
                .do(applyMw)
                .do(x => options = x)
                .do(x => bsClients.emit('options:set', {options: transform.getClientOptions(x)}))
                .publish().refCount();
            },
            /**
