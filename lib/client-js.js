...
const mergePluginOptions = require('./transform-options').mergeOptionsWithPlugins;
const fs                 = require('fs');
    ...
    return options.update(OPT_NAME, x => {
        return Immutable.fromJS([
            ...
            },
            {
                ...
                content: options.get('devMode') ? bsClient.unminified() : bsClient.minified()
            }
        ].map(x => {
